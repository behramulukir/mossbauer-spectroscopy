...
class StaticBED:
    ...
    def optimisation(self, init_num=5, max_iter=10, is_optimized=False):
        ...
        if is_optimized:
            ...
            d_opt = np.random.uniform(-3.0, 3.0, 4)
            # Take some real-world data at random points
            y_obs = self.simobj.observe(d_opt)[0]
    ...
    def save(self, filename):
        ...
        np.savez('{}.npz'.format(filename), **self.savedata, utilobj=self.utilobj, prior_samples=self.prior_samples)
